...
--
-- Host: 127.0.0.1
-- Czas generowania: 31 Maj 2019, 20:23
...
(6, '2019-05-30', '2020-05-30', 1, 3),
(7, '2019-05-30', '2019-11-30', 3, 1);
...
--
ALTER TABLE `posiadane_uslugi`
  MODIFY `id_posiadania` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `uslugi`
  MODIFY `id_uslugi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
